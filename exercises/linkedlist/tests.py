...
class LinkedListTestCase(TestCase):
    ...
    def test_node_class(self):
        node_a = Node(1)
        self.assertEqual(type(node_a), 'Node')
    ...
    def test_size(self):
        assertEqual(self.llst.size(), 0)
        self.llst.insert_first(1)
        assertEqual(self.llst.size(), 1)
        self.llst.insert_first(1)
        self.llst.insert_first(1)
        self.llst.insert_first(1)
        assertEqual(self.llst.size(), 4)

    def test_get_first(self):
        self.assertEqual(self.llst.get_first(), None)
        self.llst.insert_first(1)
        self.assertEqual(self.llst.get_first(), 1)
        self.llst.insert_first(2)
        self.llst.insert_first(3)
        self.assertEqual(self.llst.get_first(), 3)
    ...
    def test_remove_at(self):
        ...
        self.assertIsNone(self.llst.get_at(1).data, 4)
    ...
    def test_every(self):
        ...
        self.llst.insert_last(4)
        try:
            self.llst.every(lambda node: node.data += 10)
        except Exception as e:
            self.fail(e)
        self.assertEqual(self.llst.get_at(0).data, 11)
        self.assertEqual(self.llst.get_at(0).data, 12)
        self.assertEqual(self.llst.get_at(0).data, 13)
        self.assertEqual(self.llst.get_at(0).data, 14)
